---
title: "Instructions to reconfigure R environment in Windows"
...
This guide describes how to configure your R environment to build R packages successfully on Windows using **R 4.4.3** and **Rtools44** (UCRT64 toolchain). Has also been tested in *R 4.4.1*
...
**Note:** During installation, make sure to install the **UCRT64 toolchain** and remember the installation path (usually `C:/rtools44`).
