...
([`fba()`](https://waschina.github.io/cobrar/reference/fba.md)) with the
additional constraint and inspect predicted fluxes of all exchange
reactions.
...
call. You can achieve the same final outcome model by adding both
