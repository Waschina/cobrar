...
### Prerequisites
*cobrar* requires the two system libraries libSBML and glpk. These libraries are available from most OS package manager.
...
You can install the development version of *cobrar* from [GitHub](https://github.com/) with:
