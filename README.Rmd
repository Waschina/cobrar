...
[![R-CMD-check](https://github.com/Waschina/cobrar/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Waschina/cobrar/actions/workflows/R-CMD-check.yaml) [![Anaconda-Server Badge](https://anaconda.org/bioconda/r-cobrar/badges/version.svg?branch=master&kill_cache=1)](https://anaconda.org/bioconda/r-cobrar) [![Anaconda-Server Badge](https://anaconda.org/bioconda/r-cobrar/badges/downloads.svg?branch=master&kill_cache=1)](https://anaconda.org/bioconda/r-cobrar)
...
Installation of *cobrar* in Windows requires reconfiguration of the R environment for package building and installation of *Rtools*. Detailed instructions can be found in [README_WIN.md](README_WIN.md).

#### Conda

Releases of *cobrar* for linux-64 and osx-64 systems are available via [bioconda](https://bioconda.github.io/recipes/r-cobrar/README.html#package-r-cobrar).
...
-   In *sybil*, columns named "annotation" were actually concatenated CVTerms (<https://doi.org/10.2390/biecoll-jib-2015-266>). To avoid confusion with other levels of annotation, the columns (e.g. in `react_attr` or `met_attr`) are named 'CVTerms' in *cobrar*.
...
-   *cobrar* exports SBML files level 3 version 2 with `fbc` version 2 and `groups` version 1.
-   Group assignments are only supported for reactions.
-   GLPK is the default solver and is required to build the package. A plugin for IBM's ILOG CPLEX is available [here (cobrarCPLEX)](https://github.com/Waschina/cobrarCPLEX).
